...
#define MPL_DBG_ERROR_CODES                                 \
  ...
  /* 1  */ MPL_ERROR_CODE_ELEMENT(FAILED_ALLOCATING_MEMORY) \
  /* 2  */ MPL_ERROR_CODE_ELEMENT(INVALID_OPERATION)        \
  /* 3  */ MPL_ERROR_CODE_ELEMENT(FAILED_OPERATION)         \
  /* 4  */ MPL_ERROR_CODE_ELEMENT(INVALID_PARAMETER)
