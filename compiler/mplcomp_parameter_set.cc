...
#define INDENT(str) fprintf(f, "%s%s", newindent, str)
    ...
    INDENT("        uint8_array(uint8_t *arr_p, int len);\n");
    ...
    INDENT("        uint16_array(uint16_t *arr_p, int len);\n");
    ...
    INDENT("        uint32_array(uint32_t *arr_p, int len);\n");
...
#define INDENT(str) fprintf(f, "%s%s", newindent, str)
    INDENT("static char *strdup_new(const char *s)\n");
    INDENT("{\n");
    INDENT("    char *d = new char[strlen(s)+1];\n");
    INDENT("    strcpy(d, s);\n");
    INDENT("    return d;\n");
    INDENT("}\n");

    INDENT("static wchar_t *wcsdup_new(const wchar_t *s)\n");
    INDENT("{\n");
    INDENT("    wchar_t *d = new wchar_t[wcslen(s)+1];\n");
    INDENT("    wcscpy(d, s);\n");
    INDENT("    return d;\n");
    INDENT("}\n");
    ...
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint8_t[array->len];\n");
    INDENT("    memcpy(this->array.arr_p, array->arr_p, array->len * sizeof(uint8_t));\n");
    INDENT("    this->array.len = array->len;\n");
    INDENT("}\n");
    INDENT("uint8_array::uint8_array(uint8_t *arr_p, int len)\n");
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint8_t[len];\n");
    INDENT("    memcpy(this->array.arr_p, arr_p, len * sizeof(uint8_t));\n");
    INDENT("    this->array.len = len;\n");
    INDENT("}\n");
    INDENT("uint8_array::uint8_array(uint8_array &a)\n");
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint8_t[a.array.len];\n");
    ...
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint32_t[array->len];\n");
    INDENT("    memcpy(this->array.arr_p, array->arr_p, array->len * sizeof(uint32_t));\n");
    INDENT("    this->array.len = array->len;\n");
    INDENT("}\n");
    INDENT("uint32_array::uint32_array(uint32_t *arr_p, int len)\n");
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint32_t[len];\n");
    INDENT("    memcpy(this->array.arr_p, arr_p, len * sizeof(uint32_t));\n");
    INDENT("    this->array.len = len;\n");
    INDENT("}\n");
    INDENT("uint32_array::uint32_array(uint32_array &a)\n");
    INDENT("{\n");
    INDENT("    this->array.arr_p = new uint32_t[a.array.len];\n");
    ...
    INDENT("{\n");
    INDENT("    this->tuple.key_p = strdup_new(tuple->key_p);\n");
    INDENT("    this->tuple.value_p = strdup_new(tuple->value_p);\n");
    INDENT("}\n");
    INDENT("string_tuple::string_tuple(char *key_p, char *value_p)\n");
    INDENT("{\n");
    INDENT("    this->tuple.key_p = strdup_new(key_p);\n");
    INDENT("    this->tuple.value_p = strdup_new(value_p);\n");
    INDENT("}\n");
    INDENT("string_tuple::string_tuple(string_tuple &t)\n");
    INDENT("{\n");
    INDENT("    this->tuple.key_p = strdup_new(t.tuple.key_p);\n");
    INDENT("    this->tuple.value_p = strdup_new(t.tuple.value_p);\n");
    INDENT("}\n");
    INDENT("string_tuple::~string_tuple()\n");
    INDENT("{\n");
    INDENT("    delete[] tuple.key_p;\n");
    INDENT("    delete[] tuple.value_p;\n");
    INDENT("}\n");
